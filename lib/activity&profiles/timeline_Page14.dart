...
import 'package:social_meet_up/activity&profiles/posts_Pge15.dart';
import 'package:social_meet_up/utils/colors.dart';
import 'package:social_meet_up/utils/extras.dart';

class TimeLine_14 extends StatelessWidget {
  @override
                ...
                Row(
                  children: [
                    Padding(
                      ...
                      child: GestureDetector(onTap: (){navigateTo(context, PostsPage15());},
                        child: Text(
                          "Timeline",
                          style: TextStyle(
                              fontSize: 26,
            ...
            //  height: 271,
              ...
              child: Column(
                children: [
                  ListTile(
                    leading:
                    Image.asset("assets/images/johnbrown.png"),
                    title: Text(
                      "John Brown",
                      style: TextStyle(
                          fontSize: 16,
                    ...
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        image: DecorationImage(
                            image: AssetImage("assets/images/picturepink.png"),
                            fit: BoxFit.cover),
                      ...
                      children: [
                        Expanded(flex: 1,
                            child: Padding(
                              ...
                              child: Icon(Icons.share,color: lightindigo,),
                            )),
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  ListTile(
                    leading:
                    Image.asset("assets/images/jean.png"),
                    title: Text(
                      "Jean Coutu",
                      style: TextStyle(
                          fontSize: 16,
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  ListTile(
                    leading:
                    Image.asset("assets/images/maxim.png"),
                    title: Text(
                      "Maxime Barbosa",
                      style: TextStyle(
                          fontSize: 16,
